            ...
            <v-card flat outlined class="mt-8">
              <v-card-text>
                ...
                <v-text-field
                  ...
                  v-if="['inputText', 'inputColor', 'inputEmail', 'inputPassword', 'inputPhone'].includes(field.widget)"
                  :id="field.id"
...
export default {
  ...
  data: () => ({
    ...
    fieldData: { field_text: 'Lorem ipsum dolor sit amet', field_color: '#3BE40C', field_date: new Date().toISOString().substr(0, 10), field_datetime: new Date().toISOString().substr(0, 10), field_datetime__time: '00:00', field_email: '', field_password: '', field_phone: '' },
    fields: [
